...
| M9 | [m9-production-hardening.md](m9-production-hardening.md) | 进行中 | 生产加固、跨平台、兼容性与 v1 发布。2026-09-05 立项：M8 遗留（P2-F1/P3-F3/P4-F7+P4-F9）修复放行；M9-01 Round 1 交付 NodeMetrics 聚合 + Prometheus 导出 + pairing/连通性计数器（52 项本机 ctest 绿）。 |
